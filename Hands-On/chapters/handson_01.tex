...
\begin{enumerate}
    \item Buka browser melalui situs resmi \url{https://www.virtualbox.org/wiki/Downloads}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{Figure/1/download_oracle_vm_virtualbox.png}
    \caption{Tampilan saat mendownload Oracle VM VirtualBox}
\end{figure}

\subsection*{Langkah-Langkah Mengunduh File ISO Ubuntu}
\begin{enumerate}
    \item Buka browser untuk mendownload file ISO Ubuntu pada situs resmi \url{https://ubuntu.com/download/desktop}
    \item Lalu klik tombol \textbf{Download} pada halaman tersebut
    \item Tunggu sampai proses download selesai
\end{enumerate}
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{Figure/1/download_iso_ubuntu.png}
\end{figure}
